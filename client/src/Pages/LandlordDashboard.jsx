...
export default function LandlordDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white p-6">
      {/* Ambient orb */}
      <div className="pointer-events-none fixed top-[-120px] left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-blue-600/10 rounded-full blur-[100px]" />
            ...
            {payments.map((p) => (
              <div key={p.name} className="flex items-center justify-between px-4 py-3">
                ...
                <div className="text-right">
                  <p className="text-sm font-medium text-emerald-400">+{p.amount} ETB</p>
